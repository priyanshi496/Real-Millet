...
const CheckoutPage = () => {
  ...
  const deliveryCharge = safeTotal >= 2000 ? 0 : 100;
  const finalTotal = safeTotal + deliveryCharge;
  
  console.log('Debug - totalPrice:', totalPrice);
  console.log('Debug - safeTotal:', safeTotal);
  console.log('Debug - deliveryCharge:', deliveryCharge);
  console.log('Debug - finalTotal:', finalTotal);
  console.log('Debug - cartItemsList:', cartItemsList);
  ...
  const handleOnlinePayment = async () => {
    ...
    // Create a toast loading reference
    ...
    try {
      ...
      //  Remove loading toast before redirect
      ...
      //  Remove loading toast immediately on error
      toast.dismiss(loadingToast);
  
      // Show proper backend error toast
      AxiosToastError(error);
    }
  };
